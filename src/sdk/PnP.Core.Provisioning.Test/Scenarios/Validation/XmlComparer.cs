...
//
// Ported verbatim from PnPF.Test:Framework/Functional/Validators/XmlCompare.cs, with only the
// namespace changed. It is third party code that PnP Framework itself vendored, it has no
// dependencies beyond System.Xml.Linq, and rewriting it would mean the two engines' extracts were
// compared by two different comparers - which is exactly the thing the differential harness must
// not do.
using System;
