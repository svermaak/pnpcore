...
namespace PnP.Core.Provisioning.Model.Configuration
{
    public partial class ExtractConfiguration
    {
        ...
        /// <remarks>
        /// This used to take a CSOM Web and call <c>web.GetBaseTemplate()</c> itself. The base template is
        /// now resolved by the caller and passed in, which keeps the configuration model free of any
        /// dependency on a live connection - it is a serializable POCO. The engine resolves the base
        /// template through the base template manager before calling this.
        /// </remarks>
