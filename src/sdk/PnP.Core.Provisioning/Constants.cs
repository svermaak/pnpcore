...
{
    /// <summary>
    /// Constants used by the provisioning engine.
    /// </summary>
    /// <remarks>
    /// Ported from <c>PnP.Framework.Constants</c>. The two <c>[Obsolete]</c> aliases
    /// (<c>APPSIDELOADINGFEATUREID</c>, <c>MINIMALDOWNLOADSTRATEGYFEATUREID</c>) were dropped:
    /// nothing in the provisioning engine referenced them, and carrying an obsolete member
    /// into a brand new public surface makes no sense.
    /// </remarks>
    public static class Constants
    {
        // PublishingWeb - SharePoint Server Publishing - Web scope
        public static readonly Guid FeatureId_Web_Publishing = new Guid("94c94ca6-b32f-4da9-a9e3-1f3d343d7ecb");
        // PublishingSite - SharePoint Server Publishing Infrastructure - Site scope
        ...
        /// <summary>
        /// Logging source used by the provisioning engine. Emitted as the first token of every
        /// log message so provisioning output stays greppable inside a wider PnP Core log.
        /// </summary>
        internal const string LOGGING_SOURCE = "PnP.Core.Provisioning";
