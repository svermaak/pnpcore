...
{    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// Backlog <b>T10</b>, and one of spike <b>S1</b>'s "not supported" verdicts: there is no
    /// <c>Deprecate</c> anywhere in PnP Core's taxonomy model. A deprecated term stays in the store
    /// and keeps tagging existing content, but can no longer be used to tag anything new - so
    /// dropping the flag on apply would silently re-enable retired terms.
    /// </remarks>
