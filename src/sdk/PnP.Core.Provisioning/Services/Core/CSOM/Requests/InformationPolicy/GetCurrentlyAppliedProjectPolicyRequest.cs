...
namespace PnP.Core.Provisioning.Services.Core.CSOM.Requests.InformationPolicy
{
    ...
    /// </summary>
    /// <remarks>
    /// Backlog <b>T22</b>. Used on extract, to record which policy a site is under.
    /// </remarks>
    internal sealed class GetCurrentlyAppliedProjectPolicyRequest : IRequest<SitePolicyInfo>
    {
        ...
        public List<ActionObjectPath> GetRequest(IIdProvider idProvider)
        {
            ...
            var getPolicy = new StaticMethodPath
            {
                ...
                // Note the "OnWeb" suffix: the CSOM method is
                // GetCurrentlyAppliedProjectPolicyOnWeb, not GetCurrentlyAppliedProjectPolicy.
        ...
        public void ProcessResponse(string response)
        {
            ...
            {
                // No policy applied - a legitimate outcome, not an error.
                return;
            }
