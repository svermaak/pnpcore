...
namespace PnP.Core.Provisioning.Services.Core.CSOM.Requests.InformationPolicy
{
    ...
    /// </summary>
    /// <remarks>
    /// Backlog <b>T22</b>. <c>ProjectPolicy.GetProjectPolicies</c> is a static CSOM method whose
    /// first parameter is the <c>ClientRuntimeContext</c> - which is <em>not</em> serialized: the
    /// context is implicit in the request itself. Only the web is sent, as an object reference.
    /// </remarks>
