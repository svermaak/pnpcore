namespace PnP.Core.Provisioning.Model
{
    ...
    /// </summary>
    /// <remarks>
    /// A plain DTO. The provisioning schema's <c>&lt;pnp:ImageRendition&gt;</c> carries only name,
    /// width and height; <see cref="Id"/> and <see cref="Version"/> are server-assigned and are
    /// kept because <c>SetRenditions</c> round-trips the whole list rather than accepting a delta.
    /// </remarks>
