...
namespace PnP.Core.Provisioning.Services.Core.CSOM.Requests.Audit
{
    ...
    /// </summary>
    /// <remarks>
    /// Backlog <b>T21</b>. <c>ISite.Audit</c> is commented out in PnP Core, and the underlying
    /// setting has no REST surface worth using, so this reaches <c>SP.Audit.AuditFlags</c> through
    /// CSOM.
    /// </remarks>
