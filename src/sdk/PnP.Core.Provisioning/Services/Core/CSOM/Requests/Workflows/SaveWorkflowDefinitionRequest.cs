...
{    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// <para>Backlog <b>T16</b>. Constructs a <c>WorkflowDefinition</c>, populates it, and calls
    /// <c>WorkflowDeploymentService.SaveDefinition(definition)</c>, which returns the definition
    /// id.</para>
    /// <para>Saving does not publish: a saved-but-unpublished definition cannot be associated with
    /// a list. See <see cref="PublishWorkflowDefinitionRequest"/>.</para>
    /// </remarks>
    internal sealed class SaveWorkflowDefinitionRequest : WorkflowRequestBase, IRequest<WorkflowDefinitionInfo>
    {
        ...
        public List<ActionObjectPath> GetRequest(IIdProvider idProvider)
        {
            ...
            {
                // Supplying the id updates an existing definition instead of creating a new one -
                // which is what re-applying a template must do.
        ...
        {
            // SaveDefinition returns a ClientResult<Guid>, which serializes as a bare value.
