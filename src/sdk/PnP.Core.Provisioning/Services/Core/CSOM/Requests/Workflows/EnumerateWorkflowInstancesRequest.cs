...
{    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// <para>Backlog <b>T16</b>. <c>WorkflowInstanceService.CountInstances(subscription)</c>.</para>
    /// <para>PnP Framework enumerated full instances here; counting is enough for what the engine
    /// actually does with the answer - warn before replacing an association that has work in
    /// flight - and avoids materializing potentially thousands of instances to check whether the
    /// number is zero.</para>
    /// </remarks>
