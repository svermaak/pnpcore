...
{    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// Backlog <b>T16</b>. <c>EnumerateSubscriptions()</c> for everything on the site, or
    /// <c>EnumerateSubscriptionsByList(listId)</c> for one list - <c>ObjectListInstance</c> needs
    /// the latter.
    /// </remarks>
