...
{    /// <summary>
    /// Moves a web part to a different zone or position.
    /// </summary>
    /// <remarks>
    /// Backlog <b>T18</b>. <c>WebPartDefinition.MoveWebPartTo(zoneId, zoneIndex)</c>. Needed
    /// because a template describes where a web part belongs, and re-applying a template to a site
    /// whose page has drifted has to put it back.
    /// </remarks>
    internal sealed class MoveWebPartToRequest : WebPartRequestBase, IRequest<object>
    {
        ...
        internal MoveWebPartToRequest(Guid siteId, Guid webId, string serverRelativeFileUrl, Guid webPartId, string zoneId, int zoneIndex)
        {
