...
namespace PnP.Core.Provisioning.Attributes
{
    ...
    /// </summary>
    /// <remarks>
    /// This attribute is documentation, not behaviour - nothing in the engine reads it at
    /// runtime. It exists so the token reference in the SDK docs can be generated from the
    /// code rather than hand-maintained, which is how PnP Framework kept its own token list
    /// honest.
    /// </remarks>
