...
namespace PnP.Core.Provisioning.Providers.Json
{
    public class JsonPnPFormatter : ITemplateFormatterWithValidation
    {
        ...
        /// </summary>
        /// <remarks>
        /// The Newtonsoft version passed the converter per call; System.Text.Json takes it through
        /// options instead. Options instances are expensive to build and safe to share once created,
        /// hence the static field.
        /// </remarks>
        ...
        public System.IO.Stream ToFormattedTemplate(Model.ProvisioningTemplate template)
        {
            ...
            // Unicode (UTF-16) is kept deliberately: it is what PnP Framework wrote, and changing it
            // would make existing .json templates unreadable by the matching reader below.
