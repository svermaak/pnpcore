...
namespace PnP.Core.Provisioning.ObjectHandlers
{
    ...
    /// </summary>
    /// <remarks>
    /// PnP Framework typed these against <c>Microsoft.Online.SharePoint.TenantAdministration.Tenant</c>.
    /// PnP Core has no <c>Tenant</c> object: tenant scope is a <see cref="PnPContext"/> pointed at
    /// the admin site, from which <c>GetSharePointAdmin()</c>, <c>GetSiteCollectionManager()</c>
    /// and <c>GetTeamManager()</c> hang. Handlers therefore take a context like their web scoped
    /// counterparts, and reach for the admin extensions when they need them.
    /// </remarks>
