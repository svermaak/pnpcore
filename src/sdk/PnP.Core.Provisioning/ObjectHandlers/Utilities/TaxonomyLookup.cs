...
namespace PnP.Core.Provisioning.ObjectHandlers.Utilities
{
    ...
    internal static class TaxonomyLookup
    {
        ...
        /// </summary>
        /// <remarks>
        /// A data row addresses a managed metadata value either by term guid or by path. The path
        /// form is the portable one - a guid is tenant-specific - so it is the form a hand-written
        /// template uses, and it has to be walked segment by segment because Graph offers no
        /// path lookup.
        /// </remarks>
