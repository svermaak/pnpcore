...
namespace PnP.Core.Provisioning.ObjectHandlers
{
    ...
    /// </summary>
    /// <remarks>
    /// Backlog <b>T2</b>. Also a hard prerequisite for <b>T6</b> localization: SharePoint stores a
    /// user resource only for a language the web actually supports, so a template that localizes
    /// into a language it never enables here writes values that are silently discarded.
    /// </remarks>
    internal class ObjectSupportedUILanguages : ObjectHandlerBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// A tenant may not have a language pack installed for every LCID a template lists. One
        /// unavailable language should not cost the caller every other one.
        /// </remarks>
