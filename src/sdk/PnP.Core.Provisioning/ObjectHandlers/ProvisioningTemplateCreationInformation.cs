...
namespace PnP.Core.Provisioning.ObjectHandlers
{
    ...
    public class ProvisioningTemplateCreationInformation
    {
        ...
        /// </summary>
        /// <remarks>
        /// The CSOM version of this type had a <c>ProvisioningTemplateCreationInformation(Web web)</c>
        /// constructor that resolved the out of the box base template itself via
        /// <c>web.GetBaseTemplate()</c>. Resolving a base template requires a live connection, which this
        /// settings object should not own, so the caller now assigns <see cref="BaseTemplate"/> after
        /// construction - see <c>ExtractConfiguration.ToCreationInformation</c>. Leaving it null extracts
        /// everything, without diffing against a base template.
        /// </remarks>
        public ProvisioningTemplateCreationInformation()
        {
