...
namespace PnP.Core.Provisioning.ObjectHandlers
{
    ...
    /// </summary>
    /// <remarks>
    /// Backlog <b>T1</b>: <c>IRegionalSettings</c> is read-only in PnP Core, so the write side goes
    /// through <see cref="WebSettingsRestHelper"/>.
    /// </remarks>
    internal class ObjectRegionalSettings : ObjectHandlerBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// <para><b>This is where backlog <see href="#t5b">T5b</see> actually lands.</b> The
        /// provisioning schema allows <c>Umm al-Qura</c> (<c>UmAlQura = 23</c>, confirmed against
        /// the CSOM assembly) but PnP Core <b>deliberately omits it</b>, citing Microsoft's
        /// documentation listing it as unsupported in SharePoint.</para>
        /// <para>So this throws rather than substituting a default. A template asking for the Umm
        /// al-Qura calendar and quietly getting Gregorian is a worse outcome than an error - and it
        /// is exactly the class of silent-wrong-result this migration has hit repeatedly. The
        /// caller gets a named, actionable failure instead.</para>
        /// </remarks>
