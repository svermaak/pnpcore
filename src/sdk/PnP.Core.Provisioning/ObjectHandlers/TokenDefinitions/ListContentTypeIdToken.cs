...
namespace PnP.Core.Provisioning.ObjectHandlers.TokenDefinitions
{
    ...
    internal class ListContentTypeIdToken : TokenDefinition
    {
        ...
        /// <remarks>
        /// A list content type's id is its parent's id with a 00-plus-GUID suffix appended, and a
        /// template refers to it by the parent it derives from. CSOM exposed this as
        /// <c>ContentTypeId.GetParentIdValue()</c>; PnP Core has no such helper, so the same
        /// derivation is done here - see <see cref="GetParentIdValue"/>.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Content type ids are built by appending either "00" plus a 32 character hex GUID
        /// (a "deep" derivation) or two hex digits (a "shallow" one) to the parent id. Stripping
        /// the last such suffix gives the parent.
        /// </remarks>
