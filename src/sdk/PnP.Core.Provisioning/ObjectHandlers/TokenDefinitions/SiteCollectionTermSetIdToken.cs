...
namespace PnP.Core.Provisioning.ObjectHandlers.TokenDefinitions
{
    ...
    internal class SiteCollectionTermSetIdToken : TokenDefinition
    {
        ...
        /// </summary>
        /// <remarks>
        /// The Graph term store types term set ids as <see cref="string"/>, not <see cref="Guid"/>,
        /// so the parser reads them straight through rather than round-tripping via
        /// <see cref="Guid.Parse(string)"/> - which would throw on any id Graph returns in a shape
        /// CSOM never produced. Whether that can actually happen is probe (h) of spike <b>S1</b>.
        /// </remarks>
